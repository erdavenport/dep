...
###### 
# This script will plot associations for the LMM, covariates regressed out, single phase, common bacteria only, phase 4 significant associations.
# usage: ./plot_phase_4_lmm_covs_regressed_common_significant_associations_110514ERD.R
...
qvals <- read.table(file="../results/12_lmm_phase_covs_common/table_p_and_q_values_lmm_phase_4_110514ERD.txt", sep="\t", header=TRUE)
...
for (i in 1:dim(qvals)[1]) {
	...
	pdf(paste0("../results/12_lmm_phase_covs_common/boxplot_phase4_",qvals$bacteria[i],"_by_rank_",today,"ERD.pdf"))
